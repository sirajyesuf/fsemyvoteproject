...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.html"> <img src="welcomepage/img/logo.png" alt="logo"> </a>
    ...
    <section class="pricing_part section_padding single_page_pricing">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_pricing_part">
                        <img src="welcomepage/img/icon/feature_icon_1.png" alt="">
                        <p>business</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_pricing_part">
                        <img src="welcomepage/img/icon/feature_icon_2.png" alt="">
                        <p>business</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_pricing_part">
                        <img src="welcomepage/img/icon/feature_icon_3.png" alt="">
                        <p>business</p>
        ...
        <img src="welcomepage/img/left_sharp.png" alt="" class="left_shape_1">
        <img src="welcomepage/img/animate_icon/Shape-1.png" alt="" class="feature_icon_1">
        <img src="welcomepage/img/animate_icon/shape.png" alt="" class="feature_icon_4">
    </section>
    <!-- pricing part end-->
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></P>
    ...
    <!-- jquery plugins here-->
    <!-- jquery -->
    <script src="welcomepage/js/jquery-1.12.1.min.js"></script>
    <!-- popper js -->
    <script src="welcomepage/js/popper.min.js"></script>
    <!-- bootstrap js -->
    <script src="welcomepage/js/bootstrap.min.js"></script>
    <!-- easing js -->
    <script src="welcomepage/js/jquery.magnific-popup.js"></script>
    <!-- swiper js -->
    <script src="welcomepage/js/swiper.min.js"></script>
    <!-- swiper js -->
    <script src="welcomepage/js/masonry.pkgd.js"></script>
    <!-- particles js -->
    <script src="welcomepage/js/owl.carousel.min.js"></script>
    <script src="welcomepage/js/jquery.nice-select.min.js"></script>
    <!-- slick js -->
    <script src="welcomepage/js/slick.min.js"></script>
    <script src="welcomepage/js/jquery.counterup.min.js"></script>
    <script src="welcomepage/js/waypoints.min.js"></script>
    <script src="welcomepage/js/contact.js"></script>
    <script src="welcomepage/js/jquery.ajaxchimp.min.js"></script>
    <script src="welcomepage/js/jquery.form.js"></script>
    <script src="welcomepage/js/jquery.validate.min.js"></script>
    <script src="welcomepage/js/mail-script.js"></script>
    <!-- custom js -->
    <script src="welcomepage/js/custom.js"></script>
</body>
