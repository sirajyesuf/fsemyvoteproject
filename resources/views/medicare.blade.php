...
<head>
	...
	<!-- Bootstrap CSS -->
	<link rel="stylesheet" href="medicare/css/bootstrap.css">
	<link rel="stylesheet" href="medicare/vendors/linericon/style.css">
	<link rel="stylesheet" href="medicare/css/font-awesome.min.css">
	<link rel="stylesheet" href="medicare/vendors/owl-carousel/owl.carousel.min.css">
	<link rel="stylesheet" href="medicare/vendors/lightbox/simpleLightbox.css">
	<link rel="stylesheet" href="medicare/vendors/nice-select/css/nice-select.css">
	<link rel="stylesheet" href="medicare/vendors/animate-css/animate.css">
	<!-- main css -->
	<link rel="stylesheet" href="medicare/css/style.css">
</head>
		...
		<div class="container">
			<div class="row"> -->
				...
				<div class="col-lg-4 col-md-6">
					<div class="single_feature">
						<div class="feature_head">
							<img src="medicare/img/features/icon1.png" alt="">
				...
				<div class="col-lg-4 col-md-6">
					<div class="single_feature">
						<div class="feature_head">
							<img src="medicare/img/features/icon2.png" alt="">
				...
				<div class="col-lg-4 col-md-6">
					<div class="single_feature">
						<div class="feature_head">
							<img src="medicare/img/features/icon3.png" alt="">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-2 text-center col-sm-6">
					<div class="single_department">
						<div class="dpmt-thumb">
							<img src="medicare/img/department/d-icon1.png" alt="">
						</div>
						<h4>Cardiology</h4>
					</div>
				</div>
				...
				<div class="col-lg-2 text-center col-sm-6">
					<div class="single_department">
						<div class="dpmt-thumb">
							<img src="medicare/img/department/d-icon2.png" alt="">
						</div>
						<h4>Urology</h4>
					</div>
				</div>
				...
				<div class="col-lg-2 text-center col-sm-6">
					<div class="single_department">
						<div class="dpmt-thumb">
							<img src="medicare/img/department/d-icon3.png" alt="">
						</div>
						<h4>Dental Care</h4>
					</div>
				</div>
				...
				<div class="col-lg-2 text-center col-sm-6">
					<div class="single_department">
						<div class="dpmt-thumb">
							<img src="medicare/img/department/d-icon5.png" alt="">
						</div>
						<h4>Neurology</h4>
					</div>
				</div>
				...
				<div class="col-lg-2 text-center col-sm-6">
					<div class="single_department">
						<div class="dpmt-thumb">
							<img src="medicare/img/department/d-icon6.png" alt="">
						</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-sm-6">
					<div class="single_member">
						<div class="author">
							<img src="medicare/img/team/member1.png" alt="">
						</div>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="single_member">
						<div class="author">
							<img src="medicare/img/team/member2.png" alt="">
						</div>
						<div class="author_decs">
							<div class="social_icons">
								<a href="#"><i class="fa fa-facebook"></i></a>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="single_member">
						<div class="author">
							<img src="medicare/img/team/member3.png" alt="">
						</div>
						<div class="author_decs">
							<div class="social_icons">
								<a href="#"><i class="fa fa-facebook"></i></a>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="single_member">
						<div class="author">
							<img src="medicare/img/team/member4.png" alt="">
						</div>
						<div class="author_decs">
							<div class="social_icons">
								<a href="#"><i class="fa fa-facebook"></i></a>
								...
								<div class="row align-items-center">
									<div class="col-lg-4 col-md-3">
										<div class="blog_thumb">
											<img class="img-fluid" src="medicare/img/recent-blog/blog1.jpg" alt="">
										</div>
									</div>
						...
						<div class="col-lg-12 col-sm-12">
							<div class="single_blog">
								<div class="row align-items-center">
									<div class="col-lg-4 col-md-3">
										<div class="blog_thumb">
											<img class="img-fluid" src="medicare/img/recent-blog/blog2.jpg" alt="">
										</div>
									</div>
									<div class="col-lg-8 col-md-8">
										<div class="blog_details">
						...
						<div class="col-lg-12 col-sm-12">
							<div class="single_blog">
								<div class="row align-items-center">
									<div class="col-lg-4 col-md-3">
										<div class="blog_thumb">
											<img class="img-fluid" src="medicare/img/recent-blog/blog3.jpg" alt="">
										</div>
									</div>
									<div class="col-lg-8 col-md-8">
										<div class="blog_details">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<script src="medicare/js/gmaps.min.js"></script>
	<script src="medicare/js/theme.js"></script>
</body>
